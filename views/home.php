...
<body>
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li class="nav__item" id="my-questions">
                        <a href="views/myQuestion.php" class="nav__link">My Questions</a>
                    </li>
                    <li class="nav__item" id="my-answers">
                        <a href="views/myAnswers.php" class="nav__link">Mi Answers</a>
                    </li>
                    <li class="nav__item">
                        <a href="views/forum.php?subcategoryID=1&subcategoryName=Windows" class="nav__link">Forum</a>
                    </li>
                    <li class="nav__item">
                        <a href="views/contact.php" class="nav__link">Contact Us</a>
                    </li>
                </ul>
            ...
            <div class="sub-menu__wrap" id="sub-menu">
                <div class="sub__menu">
                    <div class="user__info">
                        ...
                        <h2 id="user-info"><?php echo $username; ?></h2>
                    </div>
                    <hr>
                    <a href="views/editProfile.php" class="sub-menu__link">
                        <i class="ri-settings-2-line sub-menu__icon"></i>
                        <p>Edit profile</p>
                        <span>></span>
                    </a>
                    <a href="views/editPassword.php" class="sub-menu__link">
    ...
    <main>
        <div class="container">
            <div class="banner">
                <h1>Find answers, share your knowledge, and connect with a community that has what you're looking for.</h1>
                <img src="public/images/home.jpg" alt="Main banner">
            </div>
            <div class="home__content">
                <h2>About</h2>
                <div class="info">
                    <img src="public/images/about.jpg" alt="home image">
                    <p>Technical Online Discussion Forum is a forum where members can ask questions or answer questions from other members.
                        Questions can be from different categories and subcategories.</p>
                </div>
            </div>
        </div>
    </main>
